...
export const NavigationSidebar: React.FC<NavigationSidebarProps> = ({
  ...
  return (
    <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} lg:block w-64 bg-card border-r border-border h-[calc(100vh-57px)]`}>
      <div className="p-4">
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-chart-1 to-chart-2 rounded-xl text-primary-foreground">
